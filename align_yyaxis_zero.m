%aligns the y axes of a yyaxis plot, so that the 0 lines match
%source: Davide Fenucci, 24.9.2021
%https://de.mathworks.com/matlabcentral/answers/37821-plotyy-how-to-make-yaxis-align-at-zero
%need to pass the axes/plot e.g. from ax2 = subplot(2,1,2);
